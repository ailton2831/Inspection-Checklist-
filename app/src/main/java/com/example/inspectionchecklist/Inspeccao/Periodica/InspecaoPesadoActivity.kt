...
import com.example.inspectionchecklist.databinding.InspecaopBinding

class InspecaoPesadoActivity : AppCompatActivity() {

    private lateinit var menu: InspecaopBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()

        menu = InspecaopBinding.inflate(layoutInflater)
        ...
        val radiosCertas = listOf<RadioButton>(
            ...
            menu.radioC12,menu.radioC13,menu.radioC14,menu.radioC15
        )
        ...
        val radiosNaoCerto = listOf<RadioButton>(
            ...
            menu.radioNC12,menu.radioNC13,menu.radioNC14,menu.radioNC15)
        ...
        val radiosGroup = listOf<RadioGroup>(menu.RadioP,menu.RadioP1,menu.RadioP2,menu.RadioP3,
            ...
            menu.RadioP11,menu.RadioP12,menu.RadioP13,menu.RadioP14,menu.RadioP15)
        ...
        menu.buttonInspeccao.setOnClickListener {
            if(verificarTodosEstaoMarcados()){
                ...
                if (menu.radioNC12.isChecked) listaFalhas.add("Estado geral da suspensão")
                if (menu.radioNC13.isChecked) listaFalhas.add("Eixo - desgaste e alinhamento")
                if (menu.radioNC14.isChecked) listaFalhas.add("Sistema Pneumático - freios a ar")
                if (menu.radioNC15.isChecked) listaFalhas.add("Limitador de Velocidade")
